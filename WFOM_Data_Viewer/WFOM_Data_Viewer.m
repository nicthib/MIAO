...
% Try getting most recent mouse folder
h.mouseid.String = getrecentdataset(h.initDir);
...
if strcmp(yesno,'Yes')
    ...
    set(h.xrange,'String',''); set(h.yrange,'String','');
else
...
function dsf_Callback(hObject, eventdata, h)
...
=======
>>>>>>> c7ec1f3847658da2f7160ed3233b2630431590f8
