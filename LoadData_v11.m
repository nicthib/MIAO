function [m,data] = LoadData_v11(varargin)
...
% 2: Outputs - string with up to 6 characters: rgbodn.
% Red, Green, Blue, hbO, hbR, Neural. Order doesn't matter
% 3: DSF - downsample factor (Integer).
% 4: Pathlengths - array of two pathlengths for GCaMP correction.
...
% flicker.
%
% If you want to pass an already created m struct, pass it as the 7th
% argument.
%
% Outputs:
...
%     if strcmp(varargin{7},'CorrFlicker')
%         data.red = remove_flickering(data.red,h.m.fra)
%     end
